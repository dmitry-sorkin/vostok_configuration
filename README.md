...
- [x] Откаты при смене печатающей головы;
- [x] Исправление бага PrusaSlicer, из-за которого при первой смене инструмента не применялся длинный возврат;
- [x] Быстрая прочистка печатающих голов перед началом печати.
...
4. Переместите скрипты постпроцессинга из папки `postprocess` в любую удобную вам папку на компьютере;
...
7. В профиле печати в разделе `Выходные параметры` укажите правильный путь к python3 и ранее скачанным скриптам;
